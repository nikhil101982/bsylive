...
public class AddCourseWithLectureDetailsService {
	...
	private void createLectureList(LectureByDay LectByDay) {
		if (!Objects.isNull(LectByDay)) {
			...
			lectureEntity.setLectureTypeEntity(lectureTypeObject());
	...
	// upper object
	private List<LectureTypeEntity> lectureTypeObject() {

		List<LectureTypeEntity> lectureTypeEntityList = new ArrayList<>();

		for (LectureType lectureTypeNew : lectureTypeList) {
			...
			lectureTypeEntity.setLectureSessionEntity(lectureSessionObject());
	...
	private List<LectureSessionEntity> lectureSessionObject() {
		...
		for (LectureSession lectureSession : lectureSessionList) {
			...
			lectureSessionEntity.setLectureDetailReferenceEntity(lectureReferenceObject());
	...
	private List<LectureDetailReferenceEntity> lectureReferenceObject() {
