...
@JsonPropertyOrder({ "album", "automatically_title_stream", "chat_enabled", "created_time", "embed", "from_showcase",
		"link", "live_clips", "live_destinations", "metadata", "next_occurrence_time", "pictures", "playlist_sort",
		"privacy", "rtmp_link", "schedule", "stream_description", "stream_key", "stream_password", "stream_privacy",
		"stream_title", "streamable_clip", "time_zone", "title", "uri", "user" })
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
